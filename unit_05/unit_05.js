...
function t11() {
    ...
    for (let i = 0; i < i11.length; i++) {
        out11 += i11[i].innerHTML + ' ';
...
function t12() {
    let out12 = '';
    let i12 = document.querySelectorAll('.div-12');
    for (let i = 0; i < i12.length; i++) {
        i12[i].style.background = 'orange';
    }
...
function t15() {
    for (let i = 0; i <= 10; i++) {
        document.querySelector('.out-15').textContent += (10 - i) + ' ' + i + ' ';
    }
}
