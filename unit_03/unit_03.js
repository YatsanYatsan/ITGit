...
function f10() {
    let out = document.querySelector('.out-10').innerHTML = document.querySelector('.s-100').value;
}
...
function f11() {
    let out = document.querySelector('.out-11').innerHTML = document.querySelector('.s-110').value;
}
