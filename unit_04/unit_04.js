...
let checkbox1 = document.querySelector('.i-4');
...
function f5() {
    if (checkbox2.checked) {
        document.querySelector('.out-5').innerHTML = checkbox2.value;
    }
    else {
...
function f8() {
    ...
    document.querySelector('.out-8').innerHTML += '<button class="button-primary b-81">b-81</button>';
...
function f20(e) {
    ...
    b20 = document.querySelector('.b-20');
